...
<html>
    ...
    <body>
        ...
        <?php
            if((isset($_SESSION['successful_registration_whites'])) && ($_SESSION['successful_registration_whites'] == true))
            {
                echo '<a href="login_whites.php">Click here to log in</a>';
            }
            if((isset($_SESSION['successful_registration_blacks'])) && ($_SESSION['successful_registration_blacks'] == true))
            {
                echo '<a href="login_blacks.php">Click here to log in</a>';
            }
        ?>
    </body>
</html>